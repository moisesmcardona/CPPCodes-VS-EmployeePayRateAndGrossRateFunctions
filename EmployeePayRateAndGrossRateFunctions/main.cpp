...
void DataInput(double &payRate, double &hours);
double CalculateGrossPay(double payRate, double hours);
double CalculateNetPay(double grossPay, double netpay);
void Display(double payRate, double grossPay, double netPay, double hours);

int main()
{
	double payRate, grossPay, netPay = 0, hours;
	DataInput(payRate, hours);
	grossPay = CalculateGrossPay(payRate, hours);
	netPay = CalculateNetPay(grossPay, netPay);
